...
% 使用本地字体
% 设置默认西文字体
\setmainfont[Path=./fonts/, Extension=.ttf]{FreeSerif}
\setsansfont[Path=./fonts/, Extension=.ttf]{FreeSans}
% 设置中文字体
\setCJKmainfont[Path=./fonts/, Extension=.ttf, ItalicFont=FZKai-Z03]{FZShuSong-Z01}
\setCJKsansfont[Path=./fonts/, Extension=.ttf]{FZHei-B01}
\newCJKfontfamily\kaishu[Path=./fonts/, Extension=.ttf]{FZKai-Z03}
...
\begin{center}
{\kaishu（1958年2月11日第一届全国人民代表大会第五次会议通过）}
\end{center}
\vspace{2em}

第一届全国人民代表大会第五次会议讨论了国务院周恩来总理提出的关于汉语拼音方案草案的议案，
和中国文字改革委员会吴玉章主任关于当前文字改革和汉语拼音方案的报告，决定：
一、批准汉语拼音方案。
二、原则同意吴玉章主任关于当前文字改革和汉语拼音方案的报告，
认为应该继续简化汉字，积极推广普通话；汉语拼音方案作为帮助学习汉字和推广普通话的工具，
